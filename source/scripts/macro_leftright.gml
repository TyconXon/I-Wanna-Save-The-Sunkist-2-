...
if (argument_count==0) {
    macro_leftright_last=input_leftright(key_left(),key_right(),key_left(vi_pressed),key_right(vi_pressed),key_left(vi_released),key_right(vi_released),macro_leftright_last)
    return macro_leftright_last
}
