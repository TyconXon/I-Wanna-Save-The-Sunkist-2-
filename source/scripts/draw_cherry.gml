...
draw_circle_color(-9,+9,10.5,black,black,0)
draw_circle_color(-9,+9,9.75,c1,c1,0)
draw_circle_color(-9,+9,9,col,col,0)

draw_circle_color(-7.5,+5.5,5,c2,c2,0)
draw_circle_color(-7,+5,1.25,black,black,0)
draw_line_width_color(-6.75,+5,-1.75,-2.25,1.5,black,black)
draw_line_width_color(-2.25,-2,+1.5,-2,1.5,black,black)
draw_circle_color(-1.5,-1,1.5,black,black,0)
draw_circle_color(+0.5,-1,1,black,black,0)
