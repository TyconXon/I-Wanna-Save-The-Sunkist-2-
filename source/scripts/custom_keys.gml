...
//comment the input_add above and make the key_ script return 0

//in order to add a new input to the game,
//duplicate a key_ script and add it to this list here
...
input_add(key_taunt   ,"Taunt"   ,"c"      )
input_add(key_blue    ,"Blue"    ,"a"      )
input_add(key_orange  ,"Orange"  ,"s"      )
